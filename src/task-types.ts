...
export interface Session { session_id: string; created_at: string; system_prompt: string; thinking_level?: ThinkingLevel; tools?: ToolSnapshot[]; tool_snapshot_hash?: string }
